package com.company.classmanagment.test_support;

import com.company.classmanagment.ClassManagmentApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.classmanagment.screen")
@ContextConfiguration(classes = {ClassManagmentApplication.class, UiTestAssistConfiguration.class})
