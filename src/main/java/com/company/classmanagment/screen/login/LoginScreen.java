package com.company.classmanagment.screen.login;

import com.company.classmanagment.screen.register.userregistration.UserRegistrationView;
...
public class LoginScreen extends Screen {
    ...
    @Subscribe("register")
    public void onRegister(final Action.ActionPerformedEvent event) {
        webBrowserTools.showWebPage("http://localhost:8080/#user-registration",
                ParamsMap.of("blank", "_self"));
//        screenBuilders.screen(this)
//                .withScreenClass(UserRegistrationView.class)
